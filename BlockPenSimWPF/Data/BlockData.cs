...
namespace BlockPenSimWPF.Data
{
    internal class BlockData
    {
        ...
        {
            {"LaserBlaster", new Weapon { name = "Laser Blaster", cpu = 20, damage = 22.0, pellets = 1.0, radius = 0.3, energy = 1500.0, cooldown = 0.6, impulse = 2750, splashShape = SplashShape.None  } },
            {"PlasmaCannonMax", new Weapon { name = "Plasma Cannon (37.5m)", cpu = 60, damage = 850.0, pellets = 9.0, radius = 25.0, energy = 3000.0, cooldown = 2.5, impulse = 2750, splashShape = SplashShape.Cone } },
            {"PlasmaCannon", new Weapon { name = "Plasma Cannon (78.75m)", cpu = 60, damage = 465.0, pellets = 9.0, radius = 25.0, energy = 3000.0, cooldown = 2.5, impulse = 2750, splashShape = SplashShape.Cone } },
